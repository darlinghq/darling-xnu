...
void* __mach_syscall_table[128] = {
	...
	[40] = _kernelrpc_mach_port_get_attributes_impl,
	...
	[50] = thread_get_special_reply_port_impl,
	...
	[76] = _kernelrpc_mach_port_type_impl,
	[77] = _kernelrpc_mach_port_request_notification_impl,
