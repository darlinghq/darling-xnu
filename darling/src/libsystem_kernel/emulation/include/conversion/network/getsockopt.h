#ifndef DARLING_CONVERSION_NETWORK_GETSOCKOPT
#define DARLING_CONVERSION_NETWORK_GETSOCKOPT

// Is this the right number of ticks per sec?
#define LINGER_TICKS_PER_SEC	100
...
#endif // DARLING_CONVERSION_NETWORK_GETSOCKOPT
