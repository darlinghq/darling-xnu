#ifndef DARLING_EMULATION_CONVERSION_LINUX_LINUX_SCHED_H
#define DARLING_EMULATION_CONVERSION_LINUX_LINUX_SCHED_H
...
#endif // DARLING_EMULATION_CONVERSION_LINUX_LINUX_SCHED_H